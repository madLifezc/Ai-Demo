...
public class Config {//配置文件 "/usr/local/depends/
    public static final String Word2VecModelUrl = "/data/testModel/end.json";//词向量嵌入模型（注意词向量模型无需频繁更新，只有当样本有超过50%增量时才有更新必要）
    public static final String SentenceModelUrl = "/data/testModel/sentence.json";//语义分辨模型
    public static final String onlyKeyWord = "/data/testModel/preKeyWord.json";//关键词敏感性嗅探
    public static final String KeyWordModelUrl = "/data/testModel/myKeyWord.json";//关键词查找模型
    public static final String keyWordIndex = "/data/testModel/keyWordIndex.json";//关键词索引模型
    public static final String wordUrl = "/data/testModel/word.json";//聊天词向量嵌入模型
    public static final String talkUrl = "/data/testModel/talk.json";//聊天问答模型
